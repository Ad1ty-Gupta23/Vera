...
export default function SubscriptionSelect() {
  ...
  return (
    <div
      ...
      style={{ background: '#080B18', color: '#DCE5FF', fontFamily: "'Inter', system-ui, sans-serif" }}
    >
      <AppBar title="Choose a Plan" backTo="/dashboard" backLabel="Chat" />
      ...
      <div className="px-4 py-16">
        <div className="max-w-4xl mx-auto text-center mb-12">
          ...
          <p className="mt-2 text-sm" style={{ color: '#A7AEC4' }}>
            {user?.plan === 'business'
              ? 'You can switch back to Free at any time.'
              : 'Start free, or unlock a personalized assistant for your business.'}
          </p>
          <p className="text-xs mt-3 max-w-lg mx-auto" style={{ color: 'rgba(251,191,36,0.7)' }}>
        ...
        <div className="max-w-4xl mx-auto grid gap-6 sm:grid-cols-2">
          {PLANS.map((plan) => {
            ...
            return (
              <div
                key={plan.id}
                className={`flex flex-col rounded-2xl border p-6 ${plan.highlighted
              ...
              >
                ...
                <button
                  ...
                  className={`mt-6 w-full rounded-lg px-4 py-2.5 text-sm font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed ${plan.highlighted
